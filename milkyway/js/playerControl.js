...
function handleTimelineUpdate(e) {
  ...
  // )
  previewImg.textContent = formatDuration(Math.floor(percent * video.duration))
...
const chatContainer = document.getElementById('chat-full-container');
...
function moveOffVideo(){
  ...
  offVideoChatContainer.appendChild(chatContainer);

  videoContainer.removeChild(notificationBox);
